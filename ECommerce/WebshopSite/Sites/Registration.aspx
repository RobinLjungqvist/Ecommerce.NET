...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="RegisterContent" runat="server" role="contentinfo">
        ...
        <br />
            ...
            <asp:TextBox ID="txtbox_pwreenter" runat="server" TextMode="Password"></asp:TextBox>
        ...
        <br />
         ...
         <br/>
            ...
            <asp:TextBox ID="txtbox_zipcode" runat="server" TextMode="Number"></asp:TextBox>
            <asp:RequiredFieldValidator ID="reqfield_zipcode" runat="server" ControlToValidate="txtbox_zipcode" ErrorMessage="* You must enter a zipcode" ForeColor="Red"></asp:RequiredFieldValidator>
         <br/>
