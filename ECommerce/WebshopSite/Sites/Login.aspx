...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="LoginContent" class="col-md-6" runat="server">
        ...
        <asp:RequiredFieldValidator ID="reqfieldval_username" runat="server" ControlToValidate="txtbox_username" ErrorMessage="* You must enter a username." ForeColor="Red" CssClass="validation"></asp:RequiredFieldValidator>
        </div>
        <div class="formcol">
        ...
        <asp:RequiredFieldValidator ID="reqfieldval_password" runat="server" ErrorMessage="* You must enter a password." ForeColor="Red" ControlToValidate="txtbox_password" CssClass="validation"></asp:RequiredFieldValidator>
        </div>
        <div class="formcol">
