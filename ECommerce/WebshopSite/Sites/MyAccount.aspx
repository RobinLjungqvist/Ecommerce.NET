    ...
    <div id="main" class="col-md-10">
        ...
        <br />
         ...
         <br/>
            ...
            <asp:RequiredFieldValidator ID="reqfield_password" runat="server" ControlToValidate="txtbox_password" ErrorMessage="* You must enter a new password." ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
